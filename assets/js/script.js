...
function borde(){ /* Este ejercicio se puede resolver con toggle, pero para efectos del desafio se usará este metodo para demostrar uso de if */
    if (toggle == false) { 
...
function stickersCheck(){ /* Hago un check para valores negativos con un if que lo transforma en un cero */
    ...
    let stickerTotal = Number(stickerCounter1) + Number(stickerCounter2) + Number(stickerCounter3);
